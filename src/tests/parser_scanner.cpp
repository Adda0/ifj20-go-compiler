...
TEST_F(ParserScannerTest, EOLInFunctionCall20) {
    std::string inputStr = \
        ...
        "\n"
        "func main() {\n"
        "    foo((a + foo(7, 42, foo(54 / 6, 6-9, true)) + (-9)) && !true , bar * 8 - (var2))\n"
        "}\n";
