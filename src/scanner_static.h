...
typedef enum automaton_state {
    ...
    STATE_ZERO, // 0
    STATE_ZERO_UNDERSCORE, // 0_
    STATE_BINARY, // 0b
    STATE_BINARY_NUMBER, // 0b1
    STATE_BINARY_UNDERSCORE, // 0b1_
    STATE_OCTAL, // 0o
    STATE_OCTAL_NUMBER, // 0o1
    STATE_OCTAL_UNDERSCORE, // 0o1_
    STATE_HEXADECIMAL, // 0x
    STATE_HEXADECIMAL_NUMBER, // 0x1
    STATE_HEXADECIMAL_UNDERSCORE, // 0x1_
    STATE_INT, // 1
    STATE_INT_UNDERSCORE, // 1_
    STATE_FLOAT, // 1.1
    STATE_FLOAT_UNDERSCORE, // 1.1_
    STATE_FLOAT_DOT, // 1.
    STATE_FLOAT_EXP_CHAR, // 1.1e
    STATE_FLOAT_EXP_SIGN_CHAR, // 1.1e+-
    STATE_FLOAT_EXPONENT, // 1.1e1
    STATE_FLOAT_EXPONENT_UNDERSCORE, // 1.1e1_
